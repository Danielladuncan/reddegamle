...
function updateInfoboxOre() {
  ...
  efficiency.innerHTML = "<p><strong>Fakta / Statistik:</strong> <li>70% af personer over 70 år har en form for høretab.</li><li> I flere brande på plejehjem er beboere ikke blevet vækket af sirener.</li></p>";
  requirement.innerHTML = "<p><strong>Mulige løsninger:</strong> <li> Kombinér lydalarmer med blinkende lys eller vibrationspuder.</li>  <li>Brug tydelige håndbevægelser og visuelle instruktioner.</li></p>";
}
...
function updateInfoboxOje() {
  ...
  efficiency.innerHTML = "<p><strong>Fakta / Statistik:</strong> <li>Hver tredje over 75 år har problemer med synet, selv med briller.</li><li> 40% af faldulykker på plejehjem sker under stressede situationer.</li> </p>";
  requirement.innerHTML =
    "<p><strong>Mulige løsninger: </strong><li> Brug lysende gulvmarkeringer og tydelig belysning mod udgange.</li> <li> Fjern løse tæpper og forhindringer i flugtveje.</li>  <li>Sørg for, at personalet ledsager de mest udsatte beboere fysisk.</li></p>";
}

function updateInfoboxBen() {
  title.textContent = "Dårligt gående – Langsom evakuering";
  placeholder.innerHTML = "<p>En stor del af ældre beboere har nedsat mobilitet. Det betyder, at de bevæger sig langsomt, har brug for hjælpemidler eller helt afhænger af personale for at komme ud.</p>";
  efficiency.innerHTML = "<p><strong>Fakta / Statistik:</strong><li>6 ud af 10 plejehjemsbeboere har brug for hjælp til at bevæge sig fra seng til stol</li><li>Evakuering kan tage op til 3 gange længere tid end hos raske voksne.</li></p>";
  requirement.innerHTML =
    "<p><strong>Mulige løsninger:</strong><li> Brug særlige evakueringsstole ved trapper.</li>  <li>Tilknyt personale til bestemte beboere ved evakuering.</li> <li>Planlæg realistiske evakueringsøvelser med fokus på langsom mobilitet.</li></p>";
}
